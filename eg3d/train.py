...
@click.option('--l2cs-path',    help='Path to L2CS dataset',                                    type=str)
...
def main(**kwargs):
    ...
    c.loss_kwargs.l2cs_path = opts.l2cs_path
    print(f'c.loss_kwargs.l2cs_path: {c.loss_kwargs.l2cs_path}')
